...
export function Privacy() {
  return (
    <div className="container">
      ...
      <p>
        Your privacy is important to us. It is Build Private Ethereum Networks
        policy to respect your privacy regarding any information we may collect
        from you across our website, https://build-private-ethereum-networks.netlify.app/, and other sites we own and operate.
      </p>
      <p>
      ...
      <p>This policy is effective as of 1 July 2021.</p>
    </div>
  );
}